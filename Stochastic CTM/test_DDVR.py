...
if __name__ == '__main__':
    ...
    lp_opt = -2.433378462e+04
    mip_opt = -2.381745356029e+04
    rounding = True
    ...
    f = open("log/ADMM_LP_T8_group.log", 'w+')
    f.close()
    ms_start = time.time()
    for i in range(0, num_iterations):
        ...
        f = open("log/ADMM_LP_T8_group.log", "a+")
    ...
    ms_end = time.time()
    f = open('log/ADMM_LP_rounding_T8_group.log',"w+")
    ...
    f = open("log/ADMM_LP_rounding_T8_group.log", "a+")
